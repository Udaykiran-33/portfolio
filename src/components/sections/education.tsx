        ...
        <div className="flex flex-col gap-4">
          {education.map((item, index) => (
            <BlurFade key={item.institute} delay={0.05 + index * 0.05} inView>
              <div className="flex flex-col gap-1 rounded-xl bg-[var(--gray-2)] p-5 md:flex-row md:items-baseline md:justify-between">
                <div>
                  <p className="text-[12px] font-mono text-[var(--gray-6)]">
                    {item.period}
                  </p>
                  <h3 className="mt-1 text-[15px] font-semibold tracking-[-0.01em] text-[var(--gray-12)]">
                    {item.program}
                  </h3>
                  <p className="text-[14px] text-[var(--gray-9)]">
                    {item.institute}
                  </p>
                ...
                <p className="mt-3 text-[13px] leading-[1.6] text-[var(--gray-8)] md:mt-0 md:max-w-[360px]">
                  {item.note}
                </p>
              </div>
            </BlurFade>
